...
export class Contract extends ethereum.SmartContract {
  ...
  Allowance(_owner: Address, _receiver: Address): BigInt {
  ...
  balancesOf(param0: Address): BigInt {
    let result = super.call("balancesOf", "balancesOf(address):(uint256)", [
  ...
  try_balancesOf(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall("balancesOf", "balancesOf(address):(uint256)", [
      ethereum.Value.fromAddress(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  checkBalance(_ownerOfToken: Address): BigInt {
    let result = super.call("checkBalance", "checkBalance(address):(uint256)", [
      ethereum.Value.fromAddress(_ownerOfToken)
    ]);

    return result[0].toBigInt();
  }

  try_checkBalance(_ownerOfToken: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "checkBalance",
  ...
  totalSupplyIs(): BigInt {
    let result = super.call("totalSupplyIs", "totalSupplyIs():(uint256)", []);

    return result[0].toBigInt();
  }

  try_totalSupplyIs(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "totalSupplyIs",
      "totalSupplyIs():(uint256)",
      []
    );
    if (result.reverted) {
      return new ethereum.CallResult();
